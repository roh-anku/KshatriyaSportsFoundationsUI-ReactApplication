                    ...
                    <div className="row footer-agile-grids text-center">
                        ...
                        <div className="col-lg-4 col-md-4 col-sm-12 wthree-left-right">
                            ...
                            <div className="wls-hours-list">
                                <ul>
                                    <li className="d-flex">Monday:  <span className="time ml-auto">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;5 PM - 9 PM</span></li>
                                    <li className="d-flex">Tuesday:  <span className="time ml-auto">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;5 PM - 9 PM</span></li>
                                    <li className="d-flex">Wednesday:<span className="time ml-auto">&nbsp;5 PM - 9 PM</span></li>
                                    <li className="d-flex">Thursday: <span className="time ml-auto">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;5 PM - 9 PM</span></li>
                                    <li className="d-flex">Friday:   <span className="time ml-auto">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;5 PM - 9 PM</span></li>
                                    <li className="d-flex">Saturday: <span className="time ml-auto"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;5 PM - 9 PM</span></li>
